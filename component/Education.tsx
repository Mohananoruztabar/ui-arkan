    ...
    <div className='mt-16'>
        <Container>
            <div className='flex justify-between text-right'>
                ...
                <h2 className='text-2xl text-gray-600 font-bold'>جدید ترین آموزش های ما</h2>
            </div>
            <div className='grid grid-cols-2 md:grid-cols-3 gap-5 mt-10'>
                <div className='bg-white shadow1 rounded-xl p-2'>
                    ...
                    <div className='flex justify-between items-center'>
                        <ul className='flex'>
                            <li className='text-starbg1 lg:text-2xl'><FaStar /></li>
                            <li className='text-starbg1 lg:text-2xl'><FaStar /></li>
                            <li className='text-starbg1 lg:text-2xl'><FaStar /></li>
                            <li className='text-starbg2 lg:text-2xl'><FaStar /></li>
                            <li className='text-starbg2 lg:text-2xl'><FaStar /></li>
                        </ul>
                        <div className='flex lg:justify-end-safe items-center mt-2'>
                            <h2 className='text-sm text-gray-600'>صمد سپهری</h2>
                    ...
                    <div className='text-right flex justify-between mt-5 items-center'>
                        <button className='w-36 h-10 lg:w-44 lg:h-12 text-[12px] lg:text-sm bg-btn2 text-gray-600 ml-5 rounded-lg font-bold'>ثبت نام در دوره</button>
